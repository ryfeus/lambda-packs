...
@tf_export('image.decode_and_crop_jpeg')
...
@tf_export('image.extract_jpeg_shape')
...
@tf_export('image.resize_bicubic')
...
@tf_export('image.resize_bilinear')
...
@tf_export('image.resize_nearest_neighbor')
