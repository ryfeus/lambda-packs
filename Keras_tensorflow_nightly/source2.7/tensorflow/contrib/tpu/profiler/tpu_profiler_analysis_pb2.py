...
_NEWPROFILESESSIONRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='session_id', full_name='tensorflow.NewProfileSessionResponse.session_id', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PROFILESESSIONDATAREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tool_name', full_name='tensorflow.ProfileSessionDataRequest.tool_name', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='parameters', full_name='tensorflow.ProfileSessionDataRequest.parameters', index=3,
...
_NEWPROFILESESSIONREQUEST.fields_by_name['request'].message_type = tensorflow_dot_contrib_dot_tpu_dot_profiler_dot_tpu__profiler__pb2._PROFILEREQUEST
...
NewProfileSessionRequest = _reflection.GeneratedProtocolMessageType('NewProfileSessionRequest', (_message.Message,), dict(
  ...
  __module__ = 'tensorflow.contrib.tpu.profiler.tpu_profiler_analysis_pb2'
...
_PROFILESESSIONDATAREQUEST_PARAMETERSENTRY.has_options = True
_PROFILESESSIONDATAREQUEST_PARAMETERSENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))

_TPUPROFILEANALYSIS = _descriptor.ServiceDescriptor(
  name='TPUProfileAnalysis',
  full_name='tensorflow.TPUProfileAnalysis',
  file=DESCRIPTOR,
  index=0,
  options=None,
  ...
  _descriptor.MethodDescriptor(
    name='NewSession',
    full_name='tensorflow.TPUProfileAnalysis.NewSession',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='EnumSessions',
    full_name='tensorflow.TPUProfileAnalysis.EnumSessions',
    index=1,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='tensorflow.TPUProfileAnalysis.GetSessionToolData',
    index=2,
    containing_service=None,
...
_sym_db.RegisterServiceDescriptor(_TPUPROFILEANALYSIS)

DESCRIPTOR.services_by_name['TPUProfileAnalysis'] = _TPUPROFILEANALYSIS
