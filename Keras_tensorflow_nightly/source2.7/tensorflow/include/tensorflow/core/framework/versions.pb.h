...
namespace google {
namespace protobuf {
template<> ::tensorflow::VersionDef* Arena::CreateMessage< ::tensorflow::VersionDef>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace tensorflow {
...
class VersionDef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.VersionDef) */ {
 public:
  ...
  inline VersionDef* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::CreateMessage<VersionDef>(NULL);
  }
 ...
 private:
  ...
  friend struct ::protobuf_tensorflow_2fcore_2fframework_2fversions_2eproto::TableStruct;
  friend void ::protobuf_tensorflow_2fcore_2fframework_2fversions_2eproto::InitDefaultsVersionDefImpl();
};
// ===================================================================
