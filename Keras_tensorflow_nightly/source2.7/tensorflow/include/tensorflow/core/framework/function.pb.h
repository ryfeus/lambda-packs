...
namespace google {
namespace protobuf {
template<> ::tensorflow::FunctionDef* Arena::CreateMessage< ::tensorflow::FunctionDef>(Arena*);
template<> ::tensorflow::FunctionDefLibrary* Arena::CreateMessage< ::tensorflow::FunctionDefLibrary>(Arena*);
template<> ::tensorflow::FunctionDef_AttrEntry_DoNotUse* Arena::CreateMessage< ::tensorflow::FunctionDef_AttrEntry_DoNotUse>(Arena*);
template<> ::tensorflow::FunctionDef_RetEntry_DoNotUse* Arena::CreateMessage< ::tensorflow::FunctionDef_RetEntry_DoNotUse>(Arena*);
template<> ::tensorflow::GradientDef* Arena::CreateMessage< ::tensorflow::GradientDef>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace tensorflow {
...
class FunctionDefLibrary : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.FunctionDefLibrary) */ {
 public:
  ...
  inline FunctionDefLibrary* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::CreateMessage<FunctionDefLibrary>(NULL);
  }
 ...
 private:
  ...
  friend void ::protobuf_tensorflow_2fcore_2fframework_2ffunction_2eproto::InitDefaultsFunctionDefLibraryImpl();
};
// -------------------------------------------------------------------
...
class FunctionDef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.FunctionDef) */ {
 public:
  ...
  inline FunctionDef* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::CreateMessage<FunctionDef>(NULL);
  }
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_tensorflow_2fcore_2fframework_2ffunction_2eproto::TableStruct;
  friend void ::protobuf_tensorflow_2fcore_2fframework_2ffunction_2eproto::InitDefaultsFunctionDefImpl();
};
// -------------------------------------------------------------------
...
class GradientDef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.GradientDef) */ {
 public:
  ...
  inline GradientDef* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::CreateMessage<GradientDef>(NULL);
  }
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_tensorflow_2fcore_2fframework_2ffunction_2eproto::TableStruct;
  friend void ::protobuf_tensorflow_2fcore_2fframework_2ffunction_2eproto::InitDefaultsGradientDefImpl();
};
// ===================================================================
