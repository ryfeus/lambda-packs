...
namespace google {
namespace protobuf {
template<> ::tensorflow::NodeDef* Arena::CreateMessage< ::tensorflow::NodeDef>(Arena*);
template<> ::tensorflow::NodeDef_AttrEntry_DoNotUse* Arena::CreateMessage< ::tensorflow::NodeDef_AttrEntry_DoNotUse>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace tensorflow {
...
class NodeDef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.NodeDef) */ {
 public:
  ...
  inline NodeDef* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::CreateMessage<NodeDef>(NULL);
  }
 ...
 private:
  ...
  friend void ::protobuf_tensorflow_2fcore_2fframework_2fnode_5fdef_2eproto::InitDefaultsNodeDefImpl();
};
// ===================================================================
