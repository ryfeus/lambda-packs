...
inline void InitDefaults() {
  InitDefaultsAllocationDescription();
}
}  // namespace protobuf_tensorflow_2fcore_2fframework_2fallocation_5fdescription_2eproto
...
namespace google {
namespace protobuf {
template<> ::tensorflow::AllocationDescription* Arena::CreateMessage< ::tensorflow::AllocationDescription>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace tensorflow {
...
class AllocationDescription : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.AllocationDescription) */ {
 public:
  ...
  inline AllocationDescription* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::CreateMessage<AllocationDescription>(NULL);
  }
 ...
 private:
  ...
  friend void ::protobuf_tensorflow_2fcore_2fframework_2fallocation_5fdescription_2eproto::InitDefaultsAllocationDescriptionImpl();
};
// ===================================================================
