...
namespace google {
namespace protobuf {
template<> ::tensorflow::SaverDef* Arena::CreateMessage< ::tensorflow::SaverDef>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace tensorflow {
...
class SaverDef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.SaverDef) */ {
 public:
  ...
  inline SaverDef* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::CreateMessage<SaverDef>(NULL);
  }
 ...
 private:
  ...
  friend void ::protobuf_tensorflow_2fcore_2fprotobuf_2fsaver_2eproto::InitDefaultsSaverDefImpl();
};
// ===================================================================
