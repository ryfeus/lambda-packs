...
_SESSIONSTATUS = _descriptor.Descriptor(
  name='SessionStatus',
  full_name='tensorflow.SessionStatus',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='event', full_name='tensorflow.SessionStatus.event', index=0,
...
_SESSIONSTATUS.fields_by_name['event'].message_type = _EVENT
