...
_decode_json_example_outputs = ["binary_examples"]
...
_ParseExampleOutput = _collections.namedtuple("ParseExample",
                                              __parse_example_outputs)
...
_ParseSingleSequenceExampleOutput = _collections.namedtuple("ParseSingleSequenceExample",
                                                            __parse_single_sequence_example_outputs)
...
_string_to_number_outputs = ["output"]
