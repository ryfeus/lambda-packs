...
class VariableDef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.VariableDef) */ {
 public:
  ...
  static const VariableDef* internal_default_instance();
  ...
  void UnsafeMergeFrom(const VariableDef& from);
  protected:
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_tensorflow_2fcore_2fframework_2fvariable_2eproto_impl();
  friend void  protobuf_AddDesc_tensorflow_2fcore_2fframework_2fvariable_2eproto_impl();
...
extern ::google::protobuf::internal::ExplicitlyConstructed<VariableDef> VariableDef_default_instance_;
...
class SaveSliceInfoDef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.SaveSliceInfoDef) */ {
 public:
  ...
  static const SaveSliceInfoDef* internal_default_instance();
  ...
  void UnsafeMergeFrom(const SaveSliceInfoDef& from);
  protected:
...
extern ::google::protobuf::internal::ExplicitlyConstructed<SaveSliceInfoDef> SaveSliceInfoDef_default_instance_;
