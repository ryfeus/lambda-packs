...
class NamedTensorProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.NamedTensorProto) */ {
 public:
  ...
  static const NamedTensorProto* internal_default_instance();
  ...
  void UnsafeMergeFrom(const NamedTensorProto& from);
  protected:
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_tensorflow_2fcore_2fprotobuf_2fnamed_5ftensor_2eproto_impl();
  friend void  protobuf_AddDesc_tensorflow_2fcore_2fprotobuf_2fnamed_5ftensor_2eproto_impl();
...
extern ::google::protobuf::internal::ExplicitlyConstructed<NamedTensorProto> NamedTensorProto_default_instance_;
