...
class SaverDef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.SaverDef) */ {
 public:
  ...
  static const SaverDef* internal_default_instance();
  ...
  void UnsafeMergeFrom(const SaverDef& from);
  protected:
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_tensorflow_2fcore_2fprotobuf_2fsaver_2eproto_impl();
  friend void  protobuf_AddDesc_tensorflow_2fcore_2fprotobuf_2fsaver_2eproto_impl();
...
extern ::google::protobuf::internal::ExplicitlyConstructed<SaverDef> SaverDef_default_instance_;
