...
class AttrValue_ListValue : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.AttrValue.ListValue) */ {
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_tensorflow_2fcore_2fframework_2fattr_5fvalue_2eproto_impl();
  friend void  protobuf_AddDesc_tensorflow_2fcore_2fframework_2fattr_5fvalue_2eproto_impl();
