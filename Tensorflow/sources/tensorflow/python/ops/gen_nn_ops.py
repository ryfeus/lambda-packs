...
_BatchNormWithGlobalNormalizationGradOutput = _collections.namedtuple("BatchNormWithGlobalNormalizationGrad",
...
_conv3d_backprop_filter_v2_outputs = ["output"]
...
_conv3d_backprop_input_v2_outputs = ["output"]
...
_FractionalAvgPoolOutput = _collections.namedtuple("FractionalAvgPool",
                                                   _fractional_avg_pool_outputs)
...
__fractional_avg_pool_grad_outputs = ["output"]
...
_FractionalMaxPoolOutput = _collections.namedtuple("FractionalMaxPool",
                                                   _fractional_max_pool_outputs)
...
__fractional_max_pool_grad_outputs = ["output"]
...
_FusedBatchNormOutput = _collections.namedtuple("FusedBatchNorm",
                                                __fused_batch_norm_outputs)
...
_FusedBatchNormGradOutput = _collections.namedtuple("FusedBatchNormGrad",
                                                    _fused_batch_norm_grad_outputs)
...
def fused_batch_norm_grad(y_backprop, x, scale, reserve_space_1,
  ...
  Args:
    y_backprop: A `Tensor`. Must be one of the following types: `float32`, `float64`, `int64`, `int32`, `uint8`, `uint16`, `int16`, `int8`, `complex64`, `complex128`, `qint8`, `quint8`, `qint32`, `half`.
...
_fused_pad_conv2d_outputs = ["output"]
...
_fused_resize_and_pad_conv2d_outputs = ["output"]
...
__log_softmax_outputs = ["logsoftmax"]
...
_MaxPoolWithArgmaxOutput = _collections.namedtuple("MaxPoolWithArgmax",
...
_QuantizedAvgPoolOutput = _collections.namedtuple("QuantizedAvgPool",
...
_QuantizedBatchNormWithGlobalNormalizationOutput = _collections.namedtuple("QuantizedBatchNormWithGlobalNormalization",
...
_QuantizedBiasAddOutput = _collections.namedtuple("QuantizedBiasAdd",
...
_QuantizedConv2DOutput = _collections.namedtuple("QuantizedConv2D",
...
_QuantizedMaxPoolOutput = _collections.namedtuple("QuantizedMaxPool",
...
_QuantizedReluOutput = _collections.namedtuple("QuantizedRelu",
...
_QuantizedRelu6Output = _collections.namedtuple("QuantizedRelu6",
...
_QuantizedReluXOutput = _collections.namedtuple("QuantizedReluX",
...
_SoftmaxCrossEntropyWithLogitsOutput = _collections.namedtuple("SoftmaxCrossEntropyWithLogits",
...
_SparseSoftmaxCrossEntropyWithLogitsOutput = _collections.namedtuple("SparseSoftmaxCrossEntropyWithLogits",
...
_TopKOutput = _collections.namedtuple("TopK", __top_k_outputs)
...
_TopKV2Output = _collections.namedtuple("TopKV2", __top_kv2_outputs)
