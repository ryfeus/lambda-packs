...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='tensorflow',
  syntax='proto3',
  serialized_pb=_b('\n(tensorflow/core/framework/function.proto\x12\ntensorflow\x1a*tensorflow/core/framework/attr_value.proto\x1a&tensorflow/core/framework/op_def.proto\"j\n\x12\x46unctionDefLibrary\x12)\n\x08\x66unction\x18\x01 \x03(\x0b\x32\x17.tensorflow.FunctionDef\x12)\n\x08gradient\x18\x02 \x03(\x0b\x32\x17.tensorflow.GradientDef\"\x95\x02\n\x0b\x46unctionDef\x12$\n\tsignature\x18\x01 \x01(\x0b\x32\x11.tensorflow.OpDef\x12*\n\x04node\x18\x02 \x03(\x0b\x32\x1c.tensorflow.FunctionDef.Node\x1a\xb3\x01\n\x04Node\x12\x0b\n\x03ret\x18\x01 \x03(\t\x12\n\n\x02op\x18\x02 \x01(\t\x12\x0b\n\x03\x61rg\x18\x03 \x03(\t\x12\x0b\n\x03\x64\x65p\x18\x04 \x03(\t\x12\x34\n\x04\x61ttr\x18\x05 \x03(\x0b\x32&.tensorflow.FunctionDef.Node.AttrEntry\x1a\x42\n\tAttrEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12$\n\x05value\x18\x02 \x01(\x0b\x32\x15.tensorflow.AttrValue:\x02\x38\x01\";\n\x0bGradientDef\x12\x15\n\rfunction_name\x18\x01 \x01(\t\x12\x15\n\rgradient_func\x18\x02 \x01(\tB,\n\x18org.tensorflow.frameworkB\x0e\x46unctionProtosP\x01\x62\x06proto3')
  ,
  dependencies=[tensorflow_dot_core_dot_framework_dot_attr__value__pb2.DESCRIPTOR,tensorflow_dot_core_dot_framework_dot_op__def__pb2.DESCRIPTOR,])
...
_FUNCTIONDEF_NODE_ATTRENTRY = _descriptor.Descriptor(
  name='AttrEntry',
  full_name='tensorflow.FunctionDef.Node.AttrEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='tensorflow.FunctionDef.Node.AttrEntry.key', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='tensorflow.FunctionDef.Node.AttrEntry.value', index=1,
...
_FUNCTIONDEF_NODE = _descriptor.Descriptor(
  name='Node',
  full_name='tensorflow.FunctionDef.Node',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='ret', full_name='tensorflow.FunctionDef.Node.ret', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='op', full_name='tensorflow.FunctionDef.Node.op', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='arg', full_name='tensorflow.FunctionDef.Node.arg', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='dep', full_name='tensorflow.FunctionDef.Node.dep', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='attr', full_name='tensorflow.FunctionDef.Node.attr', index=4,
  ...
  nested_types=[_FUNCTIONDEF_NODE_ATTRENTRY, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_FUNCTIONDEF = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='node', full_name='tensorflow.FunctionDef.node', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_FUNCTIONDEF_NODE, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_FUNCTIONDEF_NODE_ATTRENTRY.fields_by_name['value'].message_type = tensorflow_dot_core_dot_framework_dot_attr__value__pb2._ATTRVALUE
_FUNCTIONDEF_NODE_ATTRENTRY.containing_type = _FUNCTIONDEF_NODE
_FUNCTIONDEF_NODE.fields_by_name['attr'].message_type = _FUNCTIONDEF_NODE_ATTRENTRY
_FUNCTIONDEF_NODE.containing_type = _FUNCTIONDEF
_FUNCTIONDEF.fields_by_name['signature'].message_type = tensorflow_dot_core_dot_framework_dot_op__def__pb2._OPDEF
_FUNCTIONDEF.fields_by_name['node'].message_type = _FUNCTIONDEF_NODE
...
FunctionDef = _reflection.GeneratedProtocolMessageType('FunctionDef', (_message.Message,), dict(
  ...
  Node = _reflection.GeneratedProtocolMessageType('Node', (_message.Message,), dict(
    ...
    AttrEntry = _reflection.GeneratedProtocolMessageType('AttrEntry', (_message.Message,), dict(
      DESCRIPTOR = _FUNCTIONDEF_NODE_ATTRENTRY,
      __module__ = 'tensorflow.core.framework.function_pb2'
      # @@protoc_insertion_point(class_scope:tensorflow.FunctionDef.Node.AttrEntry)
      ))
    ,
    DESCRIPTOR = _FUNCTIONDEF_NODE,
    __module__ = 'tensorflow.core.framework.function_pb2'
...
_sym_db.RegisterMessage(FunctionDef.Node)
_sym_db.RegisterMessage(FunctionDef.Node.AttrEntry)
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n\030org.tensorflow.frameworkB\016FunctionProtosP\001'))
_FUNCTIONDEF_NODE_ATTRENTRY.has_options = True
_FUNCTIONDEF_NODE_ATTRENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
