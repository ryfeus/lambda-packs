...
AdvisorOptionsProto = _reflection.GeneratedProtocolMessageType('AdvisorOptionsProto', (_message.Message,), dict(
  ...
  CheckerOption = _reflection.GeneratedProtocolMessageType('CheckerOption', (_message.Message,), dict(
...
_ADVISOROPTIONSPROTO_CHECKERSENTRY.has_options = True
_ADVISOROPTIONSPROTO_CHECKERSENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
_ADVISOROPTIONSPROTO_CHECKEROPTION_OPTIONSENTRY.has_options = True
_ADVISOROPTIONSPROTO_CHECKEROPTION_OPTIONSENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
