...
_REWRITERCONFIG_MEMOPTTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='HEURISTICS', index=3, number=3,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_REWRITERCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='disable_model_pruning', full_name='tensorflow.RewriterConfig.disable_model_pruning', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='memory_optimization', full_name='tensorflow.RewriterConfig.memory_optimization', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='memory_optimizer_target_node_name_prefix', full_name='tensorflow.RewriterConfig.memory_optimizer_target_node_name_prefix', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='auto_parallel', full_name='tensorflow.RewriterConfig.auto_parallel', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='optimizers', full_name='tensorflow.RewriterConfig.optimizers', index=7,
