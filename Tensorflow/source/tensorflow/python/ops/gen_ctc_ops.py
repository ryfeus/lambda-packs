...
_CTCBeamSearchDecoderOutput = collections.namedtuple("CTCBeamSearchDecoder",
...
_CTCGreedyDecoderOutput = collections.namedtuple("CTCGreedyDecoder",
...
_CTCLossOutput = collections.namedtuple("CTCLoss", __ctc_loss_outputs)
