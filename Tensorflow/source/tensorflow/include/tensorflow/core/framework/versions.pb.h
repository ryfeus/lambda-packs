...
class VersionDef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.VersionDef) */ {
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_tensorflow_2fcore_2fframework_2fversions_2eproto_impl();
  friend void  protobuf_AddDesc_tensorflow_2fcore_2fframework_2fversions_2eproto_impl();
  friend void protobuf_AssignDesc_tensorflow_2fcore_2fframework_2fversions_2eproto();
  friend void protobuf_ShutdownFile_tensorflow_2fcore_2fframework_2fversions_2eproto();
