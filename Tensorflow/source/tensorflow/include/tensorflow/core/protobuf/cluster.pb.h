...
class JobDef_TasksEntry;
class JobDef_TasksEntryDefaultTypeInternal;
extern JobDef_TasksEntryDefaultTypeInternal _JobDef_TasksEntry_default_instance_;
}  // namespace tensorflow
...
class JobDef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.JobDef) */ {
 ...
 private:
  ...
  public:
  class JobDef_TasksEntry : public ::google::protobuf::internal::MapEntry<JobDef_TasksEntry, 
      ::google::protobuf::int32, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_INT32,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > {
  public:
    typedef ::google::protobuf::internal::MapEntry<JobDef_TasksEntry, 
      ::google::protobuf::int32, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_INT32,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > SuperType;
    JobDef_TasksEntry();
    JobDef_TasksEntry(::google::protobuf::Arena* arena);
    void MergeFrom(const ::google::protobuf::Message& other) PROTOBUF_FINAL;
    void MergeFrom(const JobDef_TasksEntry& other);
    static const Message* internal_default_instance() { return reinterpret_cast<const Message*>(&_JobDef_TasksEntry_default_instance_); }
