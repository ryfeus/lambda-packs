...
class NameAttrList : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.NameAttrList) */ {
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  public:
  class NameAttrList_AttrEntry : public ::google::protobuf::internal::MapEntry<NameAttrList_AttrEntry, 
      ::std::string, ::tensorflow::AttrValue,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_MESSAGE,
      0 > {
  public:
    typedef ::google::protobuf::internal::MapEntry<NameAttrList_AttrEntry, 
      ::std::string, ::tensorflow::AttrValue,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_MESSAGE,
      0 > SuperType;
    NameAttrList_AttrEntry();
    NameAttrList_AttrEntry(::google::protobuf::Arena* arena);
    void MergeFrom(const ::google::protobuf::Message& other) PROTOBUF_FINAL;
    void MergeFrom(const NameAttrList_AttrEntry& other);
    static const Message* internal_default_instance() { return reinterpret_cast<const Message*>(&_NameAttrList_AttrEntry_default_instance_); }
