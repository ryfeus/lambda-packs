...
class DeviceProperties : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.DeviceProperties) */ {
 ...
 private:
  ...
  public:
  class DeviceProperties_EnvironmentEntry : public ::google::protobuf::internal::MapEntry<DeviceProperties_EnvironmentEntry, 
      ::std::string, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > {
  public:
    typedef ::google::protobuf::internal::MapEntry<DeviceProperties_EnvironmentEntry, 
      ::std::string, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > SuperType;
    DeviceProperties_EnvironmentEntry();
    DeviceProperties_EnvironmentEntry(::google::protobuf::Arena* arena);
    void MergeFrom(const ::google::protobuf::Message& other) PROTOBUF_FINAL;
    void MergeFrom(const DeviceProperties_EnvironmentEntry& other);
    static const Message* internal_default_instance() { return reinterpret_cast<const Message*>(&_DeviceProperties_EnvironmentEntry_default_instance_); }
