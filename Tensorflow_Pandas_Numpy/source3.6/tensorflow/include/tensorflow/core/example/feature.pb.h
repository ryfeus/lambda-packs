...
class FeatureLists_FeatureListEntry;
class FeatureLists_FeatureListEntryDefaultTypeInternal;
extern FeatureLists_FeatureListEntryDefaultTypeInternal _FeatureLists_FeatureListEntry_default_instance_;
class Features;
class FeaturesDefaultTypeInternal;
extern FeaturesDefaultTypeInternal _Features_default_instance_;
class Features_FeatureEntry;
class Features_FeatureEntryDefaultTypeInternal;
extern Features_FeatureEntryDefaultTypeInternal _Features_FeatureEntry_default_instance_;
class FloatList;
...
class Features : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.Features) */ {
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  public:
  class Features_FeatureEntry : public ::google::protobuf::internal::MapEntry<Features_FeatureEntry, 
      ::std::string, ::tensorflow::Feature,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_MESSAGE,
      0 > {
  public:
    typedef ::google::protobuf::internal::MapEntry<Features_FeatureEntry, 
      ::std::string, ::tensorflow::Feature,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_MESSAGE,
      0 > SuperType;
    Features_FeatureEntry();
    Features_FeatureEntry(::google::protobuf::Arena* arena);
    void MergeFrom(const ::google::protobuf::Message& other) PROTOBUF_FINAL;
    void MergeFrom(const Features_FeatureEntry& other);
    static const Message* internal_default_instance() { return reinterpret_cast<const Message*>(&_Features_FeatureEntry_default_instance_); }
...
class FeatureLists : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.FeatureLists) */ {
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  public:
  class FeatureLists_FeatureListEntry : public ::google::protobuf::internal::MapEntry<FeatureLists_FeatureListEntry, 
      ::std::string, ::tensorflow::FeatureList,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_MESSAGE,
      0 > {
  public:
    typedef ::google::protobuf::internal::MapEntry<FeatureLists_FeatureListEntry, 
      ::std::string, ::tensorflow::FeatureList,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_MESSAGE,
      0 > SuperType;
    FeatureLists_FeatureListEntry();
    FeatureLists_FeatureListEntry(::google::protobuf::Arena* arena);
    void MergeFrom(const ::google::protobuf::Message& other) PROTOBUF_FINAL;
    void MergeFrom(const FeatureLists_FeatureListEntry& other);
    static const Message* internal_default_instance() { return reinterpret_cast<const Message*>(&_FeatureLists_FeatureListEntry_default_instance_); }
    ::google::protobuf::Metadata GetMetadata() const;
  };
  private:
  ::google::protobuf::internal::MapField<
